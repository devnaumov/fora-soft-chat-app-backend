...
router.post("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, __1.DI.chatRepository.findOne({ id: req.body.chatId }, [
                        "messages",
                    ])];
            case 2:
                chat = _a.sent();
                message = new Message_1.Message(req.body.text, req.body.ownerId, req.body.chatId);
                if (chat) {
                    chat.messages.add(message);
                }
                core_1.wrap(message).assign(req.body);
                __1.DI.messageRepository.persistLater(message);
                return [4 /*yield*/, __1.DI.messageRepository.flush()];
            case 3:
                _a.sent();
                res.json(message);
                return [3 /*break*/, 5];
...
router.put("/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, __1.DI.userRepository.findOne(req.params.id)];
            case 1:
                user = _a.sent();
                if (!user) {
                ...
                return [4 /*yield*/, __1.DI.userRepository.persistAndFlush(user)];
            case 2:
                _a.sent();
                res.json(user);
                return [3 /*break*/, 4];
